...
tasks.register("copyAliasKaApk") {
    ...
    doLast {
        ...
        copy {
            ...
            into(destination)
            rename { "alias-ka-06.apk" }
        }
        logger.lifecycle("Alias-ka APK copied to ~/android/alias-ka-06.apk")
    }
}
...
tasks.register("copyAliasKaAab") {
    ...
    doLast {
        ...
        copy {
            ...
            into(destination)
            rename { "alias-ka-06.aab" }
        }
        logger.lifecycle("Alias-ka AAB copied to ~/android/alias-ka-06.aab")
    }
}
